...
import { IconServer, IconChart, IconPlaylist, IconTrash, IconCopy, IconCheck, IconPlus } from '../../icons';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <StatTile label="Almacenamiento" value={`${(data.espacio_mb / 1024).toFixed(1)} GB`} icon={IconServer} color="amber" />
      ...
      <div className="card p-5">
        ...
        <p className="text-xs text-gray-400 mb-3">Este es el enlace de tu señal, para tu web, app o reproductor.</p>
