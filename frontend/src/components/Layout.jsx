...
const TITULOS = {
  ...
  '/cliente/videos': { title: 'Gestionar videos', subtitle: 'Sube y borra los videos de tu canal' },
  '/cliente/playlist': { title: 'Playlist', subtitle: 'El orden en que tu canal emite tus videos' },
  '/cliente/enlaces': { title: 'Enlaces', subtitle: 'Direcciones de tu canal para compartir y embeber' },
  ...
  '/cliente/conectar': { title: 'Conectar', subtitle: 'Transmite en vivo desde tu PC' },
  '/cliente/aprende': { title: 'Aprende', subtitle: 'Guías para sacarle todo a tu radio' },
